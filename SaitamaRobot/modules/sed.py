...
def sed(update: Update, context: CallbackContext):
    ...
    if sed_result and update.effective_message.reply_to_message:
        ...
        try:
            ...
            update.effective_message.reply_text(
                "Hatta yatıyor musun? Görünüşe göre değil.")
            return
...
__help__ = """
 • `s/<text1>/<text2>(/<flag>)`*:* Bu mesaj üzerinde bir sed işlemi gerçekleştirmek için bir mesajı bununla yanıtlayın, tümünü \ değiştirerek
occurrences of 'metin1' ile 'metin2'. nin tekrarları. Bayraklar isteğe bağlıdır ve şu anda büyük, / küçük harflerin yoksayılması için 'i', global için 'g', \
veya hiçbirşey. Sınırlayıcılar arasında `/`, `_`, `|`, ve `:`. bulunur. Metin gruplama desteklenmektedir. Ortaya çıkan mesaj olamaz \
daha geniş {}.
*Hatırlatma:* Sed, eşleştirmeyi kolaylaştırmak için bazı özel karakterler kullanır, örneğin: `+*.?\\`
