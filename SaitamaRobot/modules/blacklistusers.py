...
def bl_user(update: Update, context: CallbackContext) -> str:
    ...
    if user_id == bot.id:
        message.reply_text(
            "Kendimi görmezden gelirsem işimi nasıl yapacağım?")
        return ""
...
def unbl_user(update: Update, context: CallbackContext) -> str:
    ...
    if sql.is_user_blacklisted(user_id):
        ...
        message.reply_text("Yine de onları hiç görmezden gelmiyorum!")
        return ""
...
def bl_users(update: Update, context: CallbackContext):
    ...
    message = "<b>Kara Listedeki Kullanıcılar</b>\n"
    if not users:
        message += "Henüz kimse yok sayilmiyor."
    else:
        message += '\n'.join(users)
