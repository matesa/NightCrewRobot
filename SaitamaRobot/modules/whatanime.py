...
async def whatanime(c: Client, m: Message):
    ...
    if not media:
        await m.reply_text('Fotoğraf veya GIF veya Video gerekli')
        return
    with tempfile.TemporaryDirectory() as tempdir:
        reply = await m.reply_text('İndiriliyor...')
        ...
        await reply.edit_text('Yükleniyor...')
            ...
            async def _send_preview():
                ...
                with tempfile.NamedTemporaryFile() as file:
                    ...
                    try:
                        ...
                        await reply.reply_text('Önizleme gönderilemiyor :/')
